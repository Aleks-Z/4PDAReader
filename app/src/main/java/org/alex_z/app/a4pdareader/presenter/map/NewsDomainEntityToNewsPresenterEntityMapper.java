...
public class NewsDomainEntityToNewsPresenterEntityMapper extends Mapper<NewsDomainEntity, NewsPresenterEntity> {
    @Override
    public NewsPresenterEntity map(NewsDomainEntity entity) {
        return new NewsPresenterEntity(entity.getTitle(), entity.getDescription());
    }
}
